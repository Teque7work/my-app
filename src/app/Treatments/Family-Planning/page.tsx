        ...
        <div className="main-content">
            <div className="relative w-full">
                ...
                <div className='container max-w-[1280px] mx-auto relative z-10'>
                    <p className='absolute bottom-20 text-white px-8 py-2 text-2xl md:text-5xl'>Family Planning</p>
                ...
                <div className='md:w-1/2 w-full mt-12'>
                 ...
                 <div className="bg-white-700 md:w-1/3 flex flex-col items-center shadow-xl">
                        ...
                        <div className="bg-white-700 md:w-1/3 flex flex-col items-center shadow-xl">
                            ...
                            />
                            <p className="text-lg mt-4 text-purple-900  pl-6 font-bold">Menstrual Issues</p></a>
                            </div>
                        </div>
                        <div className="bg-white-700 md:w-1/3 flex flex-col items-center shadow-xl">
                            <div className="flex flex-col items-left pb-8">
                            ...
                            />
                            <p className="text-lg mt-4 text-purple-900  pl-6 font-bold">Infertility Work-up</p></a>
                            </div>
                        </div>
                    </div>
                    <div>
