        ...
        <div className="main-content">
            <div className="relative w-full">
                ...
                <div className='container max-w-[1280px] mx-auto relative z-10'>
                    <p className='absolute bottom-20 text-white px-8 py-2 md:text-5xl text-4xl'>Menstrual Issues</p>
            ...
            <p className='md:text-base text-base md:pl-0  pl-6 md:pr-0 pr-6 text-justify text-[#5C5C5C]'>
                ...
                <div className='container bg-black md:hidden'> 
                    ...
                    <h1 className='text-base mb-3 font-bold md:pl-0 pl-4 md:mt-0 mt-8'>Services under Menstrual Issues</h1>
