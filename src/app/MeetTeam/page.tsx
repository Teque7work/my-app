           ...
           <div className="relative w-full">
            ...
            <div className='container max-w-[1280px] mx-auto mt-16 mb-36'>
                <div className='flex flex-wrap'>
                    <div className='w-full lg:w-1/2 mb-8 gap-4 mt-16'>
                    <h1 className='text-4xl font-bold text-purple-900'>Our Team</h1>
                        <div className='text-gray-500 font-medium   mr-8 text-justify mt-6 '>
                ...
                <div className="flex justify-center mt-14">
                    ...
                    <div className="w-1/2 flex flex-col justify-center gap-2">
                        <span className="font-medium  text-gray-600 font-bold">Member3</span>
                    ...
                    <Image src="/Images/member3.jpg" width={150} height={150}alt="Image" />
                    <div className="w-1/2 flex flex-col justify-center gap-2">
                        <span className="font-medium  text-gray-600 font-bold">Member4</span>
                        <span className="font-medium  text-gray-600">Obstetrician-Gynecologist</span>
                        <span className="text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                ...
                <div className="flex justify-center mt-14">
                    <Image src="/Images/member3.jpg" width={150} height={150}alt="Image"/>
                        <div className="w-1/2 flex flex-col justify-center gap-2">
                            <span className="font-medium  text-gray-600 font-bold">Member5</span>
                            <span className="font-medium  text-gray-600">Obstetrician-Gynecologist</span>
                            <span className="text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                    ...
                    <Image src="/Images/member3.jpg" width={150} height={150}alt="Image"  />
                    <div className="w-1/2 flex flex-col justify-center gap-2">
                        <span className="font-medium  text-gray-600 font-bold">Member6</span>
                        <span className="font-medium  text-gray-600">Obstetrician-Gynecologist</span>
                        <span className="text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
