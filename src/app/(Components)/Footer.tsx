...
<div className="container mx-auto max-w-[1280px] md:flex md:justify-between items-center space-x-10 text-white mb-16">
    
{/* <div className="container mx-auto max-w-[1280px] flex justify-between items-center space-x-10 text-white  mb-16"> */}
    
    {/* <!-- Logo Section --> */}
    <div className="md:w-1/2 w-full">
        <Image className="ml-[5px] mt-12 md:ml-[-5px]" src="/Images/Asset 5.png" width={300} height={300} alt="Spandan Maternity Home" />
    </div>

    {/* <!-- Contact Section --> */}
    <div className="flex w-full item-center md:justify-end space-x-9 mt-8 md:mt-[-120px]">
    <div className="flex w-[180px] md:w-1/3 items-center justify-center bg-pink-600 p-4 rounded h-16 md:h-[auto]">
            <span>
        ...
        <div className="flex w-[150px] md:w-1/3 items-center justify-center bg-pink-600 rounded h-16 md:h-[auto] md:justify-center">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="bg-pink-700 p-2 rounded-full  w-8 h-8 md:w-12 md:h-12 mr-4">
