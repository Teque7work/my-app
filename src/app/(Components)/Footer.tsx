    ...
    return(
        <div className="bg-[#27115f]">
            <div className="container mx-auto max-w-[1280px] md:flex md:justify-between items-center text-white mb-16">
                ...
                {/* <!-- Contact Section --> */}
                <div className="flex  flex-col md:flex-row w-11/12 md:w-full md:justify-end  md:space-x-9 ml-4 md:ml-0 mt-8 md:mt-[-120px]">
                    <div className="flex md:content-center w-full md:w-1/3 items-center justify-center bg-pink-600 p-4 rounded h-16 md:h-auto  md:ml-0 md:pr-0 pr-20 mb-8 md:mb-0 text-center">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="bg-pink-700 p-2 rounded-full w-8 h-8 md:w-12 md:h-12 mr-4">
                    ...
                    <div className="flex md:content-center w-full md:w-1/3 items-center justify-center bg-pink-600 rounded h-16 md:h-auto bg-pink md:pl-0 pl-4 ">
                        <span>
                    ...
                    <div>
                        ...
                        <p className="md:text-sm text-xs"><a href="mailto:spandanhospital@gmail.com">spandanhospital@gmail.com</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div className="container flex-col mx-auto max-w-[1280px] flex md:flex-row md:justify-between md:space-x-10 space-y-10 md:space-y-0 mb-16 text-white">
    ...
    <div className="w-full md:w-1/3 pl-4 md:pl-0">
        ...
        <p className="leading-6 text-sm">Shivam Nagar, Near Uma Nagar, Highway, Near Kutch Orthopadic Hospital, Mirjapar, Bhuj, Gujarat 370040</p>
