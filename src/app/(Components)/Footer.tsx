...
{/* <div className="container mx-auto max-w-[1280px] flex justify-between items-center space-x-10 text-white  mb-16"> */}
    ...
    {/* <!-- Contact Section --> */}
    <div className="flex w-full item-center space-x-9 mt-8 md:mt-[-120px]">
    <div className="flex w-[180px] md:w-1/2 items-center justify-center bg-pink-600 p-4 rounded h-16 md:h-[auto]">
            <span>
