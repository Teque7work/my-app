...
{/* <div className="container mx-auto max-w-[1280px] flex justify-between items-center space-x-10 text-white  mb-16"> */}
    ...
    {/* <!-- Contact Section --> */}
    <div className="flex w-1/2 space-x-9 md:mt-[-120px] mt-8">
                    <div className="flex w-full items-center justify-center bg-pink-600 p-4 rounded h-24 md:h-[auto]">
                        <span>
        ...
        <div className="flex items-center justify-center bg-pink-600 p-4 rounded">
            <span>
